...
def test_profile_negotiation_fixture_matches_wire_contract():
    ...
    assert fixture["profile_fixture_sha256"] == "d039eaf52afca6866832779261db7bdd2ffd818a36bc8ba9aea1db0c9c115012"
...
async def test_required_profile_negotiation_is_sent_and_exposed(monkeypatch):
    ...
    request = ProfileRequest("iicp.profile.compatibility.v0", "0.4.0-draft", "a" * 64, required=True)
