...
Use the repository's [private security-advisory form](https://github.com/RobLe3/iicp-client-python/security/advisories/new). Do not open a public issue for an unpatched vulnerability.
